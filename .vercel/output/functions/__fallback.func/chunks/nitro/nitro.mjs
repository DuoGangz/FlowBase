...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e8c0cdd1-1284-4bed-9341-827f162b8450",
...
const plugins = [
  _IAk7BBwXBslYCzLJVbTKnPpK9t2g1inHzY3xITNmnGI
];

const _SxA8c9 = defineEventHandler(() => {});

const _lazy_LwO5O1 = () => import('../routes/api/index.mjs');
const _lazy_Sb7ofT = () => import('../routes/api/index2.mjs');
const _lazy_7T5nbf = () => import('../routes/api/index.get.mjs');
const _lazy_tpM_PI = () => import('../routes/api/auth/bootstrap-owner.post.mjs');
const _lazy_z790Xo = () => import('../routes/api/auth/bootstrap.post.mjs');
const _lazy_xxdRdr = () => import('../routes/api/auth/firebase.post.mjs');
const _lazy_HTbz0c = () => import('../routes/api/auth/login.post.mjs');
const _lazy_ZKG7of = () => import('../routes/api/auth/logout.post.mjs');
const _lazy_764SZ9 = () => import('../routes/api/auth/me.get.mjs');
const _lazy_QORmvC = () => import('../routes/api/auth/recaptcha.post.mjs');
const _lazy_ZO1chq = () => import('../routes/api/index3.mjs');
const _lazy_mq7VXX = () => import('../routes/api/banner/settings.mjs');
const _lazy_TwG4s3 = () => import('../routes/api/files/_projectId_.mjs');
...
const _lazy_1d_96Y = () => import('../routes/api/index.get2.mjs');
const _lazy_Z4M1_d = () => import('../routes/api/index.post.mjs');
const _lazy_YY3mhv = () => import('../routes/api/roadmap/_projectId_.mjs');
const _lazy_IQTclx = () => import('../routes/api/index5.mjs');
const _lazy_iXyZS2 = () => import('../routes/api/index6.mjs');
const _lazy_j2GgUN = () => import('../routes/api/index7.mjs');
const _lazy_fxlsyO = () => import('../routes/api/index8.mjs');
const _lazy_RfEPp3 = () => import('../routes/api/todos/_projectId_.mjs');
const _lazy_a3CYsj = () => import('../routes/api/index.get3.mjs');
...
const handlers = [
  ...
  { route: '/api/assignments', handler: _lazy_Sb7ofT, lazy: true, middleware: false, method: undefined },
  { route: '/api/audit-logs', handler: _lazy_7T5nbf, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/bootstrap-owner', handler: _lazy_tpM_PI, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/bootstrap', handler: _lazy_z790Xo, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/firebase', handler: _lazy_xxdRdr, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/login', handler: _lazy_HTbz0c, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/logout', handler: _lazy_ZKG7of, lazy: true, middleware: false, method: "post" },
  { route: '/api/auth/me', handler: _lazy_764SZ9, lazy: true, middleware: false, method: "get" },
  { route: '/api/auth/recaptcha', handler: _lazy_QORmvC, lazy: true, middleware: false, method: "post" },
  { route: '/api/banner', handler: _lazy_ZO1chq, lazy: true, middleware: false, method: undefined },
  { route: '/api/banner/settings', handler: _lazy_mq7VXX, lazy: true, middleware: false, method: undefined },
  { route: '/api/files/:projectId', handler: _lazy_TwG4s3, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/api/projects', handler: _lazy_1d_96Y, lazy: true, middleware: false, method: "get" },
  { route: '/api/projects', handler: _lazy_Z4M1_d, lazy: true, middleware: false, method: "post" },
  { route: '/api/roadmap/:projectId', handler: _lazy_YY3mhv, lazy: true, middleware: false, method: undefined },
  { route: '/api/site-title', handler: _lazy_IQTclx, lazy: true, middleware: false, method: undefined },
  { route: '/api/time-entries', handler: _lazy_iXyZS2, lazy: true, middleware: false, method: undefined },
  { route: '/api/todo-items', handler: _lazy_j2GgUN, lazy: true, middleware: false, method: undefined },
  { route: '/api/todo-subitems', handler: _lazy_fxlsyO, lazy: true, middleware: false, method: undefined },
  { route: '/api/todos/:projectId', handler: _lazy_RfEPp3, lazy: true, middleware: false, method: undefined },
  { route: '/api/users', handler: _lazy_a3CYsj, lazy: true, middleware: false, method: "get" },
  { route: '/api/users', handler: _lazy_Dezstk, lazy: true, middleware: false, method: "post" },
  { route: '/api/users', handler: _lazy__WqN0Q, lazy: true, middleware: false, method: "put" },
  { route: '/api/users/password', handler: _lazy_JLRWUt, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_OjuR4I, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_OjuR4I, lazy: true, middleware: false, method: undefined }
];
